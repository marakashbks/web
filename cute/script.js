const body = document.querySelector("body");audio = new Audio('' + linkmp3.src); ftganti=0;fungsi=0;fungsiAwal=0;deffotostiker=fotostiker.src;
  ...
  new TypeIt("#kalimat", {
  strings: ["" + vketik1], startDelay: 300, speed: 20, cursor: false, deleteSpeed: 20, breakLines: false, waitUntilVisible: true, lifelike: true,
  ...
  function aktipesan1(){kalimat.innerHTML=pesan1.innerHTML;kolombaru.style="position:relative;opacity:1;transform:scale(1);";lv1.style="transform:scale(1);transition:all .5s ease"}
  ...
  new TypeIt("#kalimat", {
  strings: ["" + vketik2, "" + vketik3], startDelay: 20, speed: 32, cursor: true, deleteSpeed: 20, breakLines: false, waitUntilVisible: true, lifelike: true,
  afterComplete: function(){
  ...
  new TypeIt("#pesan4", {
  strings: ["" + vketik4], startDelay: 1, speed: 34, cursor: true, waitUntilVisible: true, lifelike: true,
  afterComplete: function(){
    pesan4.innerHTML=vketik4;
    
    const hitunganElem = document.getElementById("hitungan");
    let hitungan = parseInt(hitunganElem.textContent);
    const countdown = setInterval(() => {
	  hitungan--;
	  hitunganElem.textContent = hitungan;
  ...
  new TypeIt("#pesan5", {
  strings: ["" + vketik5], startDelay: 1, speed: 34, cursor: true, waitUntilVisible: true, lifelike: true,
  afterComplete: function(){
    pesan5.innerHTML=vketik5;
    pesan5.style="transform:scale(1.3);transition:all .5s ease";
    setTimeout(aktipesan6,1200);
  },}).go();
  }
  ...
  new TypeIt("#pesan6", {
  strings: ["" + vketik6], startDelay: 1, speed: 34, cursor: true, waitUntilVisible: true, lifelike: true,
  afterComplete: function(){
    pesan6.innerHTML=vketik6;
    setTimeout(aktipesan7,1200);
  },}).go();
  }
  ...
  new TypeIt("#pesan7", {
  strings: ["" + vketik7], startDelay: 1, speed: 34, cursor: true, waitUntilVisible: true, lifelike: true,
  afterComplete: function(){
  ...
  new TypeIt("#pesan8", {
  strings: ["" + vketik8], startDelay: 1, speed: 34, cursor: true, waitUntilVisible: true, lifelike: true,
  afterComplete: function(){
  ...
  let loveElement = document.getElementById("lv1");
        let clickCount = 0;
        let currentScale = 1;
        ...
        loveElement.addEventListener("click", function() {
            ...
            setTimeout(() => {
                loveElement.style.animation = "";
            }, 700);

            if (clickCount === 3) {
                kolombaru.style="position:relative;transform:scale(1)";fthilang();ftganti=1;setTimeout(ftmuncul,300);otomatis();
